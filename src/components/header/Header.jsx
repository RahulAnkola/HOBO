    ...
    <div className="header">
        <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
            ...
            <p className="headerDesc">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ex corporis at, optio, labore minima mollitia iure doloribus autem cumque molestiae ea fugit ipsum, harum tempore nesciunt. Quo perspiciatis similique quae.
            </p>
